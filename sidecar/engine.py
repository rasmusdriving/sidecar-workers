...
def command(config, job, data):
    ...
    candidates = [os.environ.get('SIDECAR_DEVIN_BIN', ''), '/Applications/Devin - Next.app/Contents/Resources/app/extensions/windsurf/devin/bin/devin', '/Applications/Devin.app/Contents/Resources/app/extensions/windsurf/devin/bin/devin']
    ...
    return cmd, {**os.environ, 'MCO_CONFIG_DIR': str(conf), 'MCO_PERMISSION_DIR': str(job / 'permissions')}
